...
async function main() {
  ...
  const posts = [
    ...
    { communityId: "3", title: "So, what did you think of last nights episode?", content: "I think it was great, how about you?", tagline: "It was great, I'd say.", public: true, authorId: "2", imageurl: null, imagealt: null, },
    { communityId: "2", title: "Feature suggestion", content: "What if we implement this feature, using the code above?", tagline: "My new feature request.", public: true, authorId: "3", imageurl: "/images/uploaded/code.png", imagealt: "The code in question.", },
    { communityId: "5", title: "I think \"Snakes on a Plane\" was just okay.", content: "# Hah, just kidding. \n It's actually great.", tagline: "Look inside.", public: true, authorId: "4", imageurl: null, imagealt: null, },
