...
async function main() {
  ...
  const posts = [
    ...
    { communityId: "6", title: "History of the World - Part 1 - Latin", content: "./posts_md/history1.md", tagline: null, public: true, authorId: "4", imageurl: null, imagealt: null, createdAt: new Date() },
  ];
