...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col p-12 w-full">
      <div className="error flex flex-col gap-4 w-full">
            ...
            <div className="flex flex-row gap-2 w-full">
                ...
                ]} btn_title="Sort Posts" />
            </div>
              
            <CardPost title='Welcome to CMD/>' community='meta' author="James Doyle" upvotes={1} downvotes={1} submitted='23-2-23' ratio='23%' subtitle='This is the subtitle.' link='/posts' image_src='/images/testmeme.webp' />
