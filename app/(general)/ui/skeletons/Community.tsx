export function CardCommunitySkeleton() {
    return (
        <div className="flex flex-row w-full items-center gap-4 relative group transition-all bg-card border-0 border-border group-hover/title:!border-white h-fit rounded-md px-6 py-6">
            <div className='bg-border rounded-md animate-pulse !w-[50px] !h-[50px]' /> 
            <div className="flex w-full bg-transparent h-fit flex-col gap-1"> 
                <div className='bg-border rounded-md animate-pulse !w-[75px] !h-[28px]' /> 
                <div className='bg-border rounded-md animate-pulse !w-[290px] !h-[20px]' /> 
            </div>
        </div>
    );
}
