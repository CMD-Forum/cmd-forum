...
export function AlertWarning(props: AlertProps) {
    ...
    return (
        ...
        <div className='w-full bg-zinc-950 border-l-8 border-orange-500 bg-opacity-50 rounded-md p-5 facebookTheme:p-3 facebookTheme:border-[#b3b3b3] facebookTheme:bg-white facebookTheme:rounded-none'>
