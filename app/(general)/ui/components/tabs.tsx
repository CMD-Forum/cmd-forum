    ...
    return (
        ...
        <div className="flex flex-col md:flex-row gap-8 w-full justify-center">
            <div className="flex flex-col h-full md:!w-[300px] w-full gap-2">
                <button className={`navlink !w-full !px-2.5 !gap-2 !border-1 ${activeTab === 1 ? "navlink-full" : ""}`} onClick={() => setActiveTab(1)}><ChatBubbleBottomCenterTextIcon className={"w-5 h-5"} />Post</button>
                <button className={`navlink !w-full !px-2.5 !gap-2 !border-1 ${activeTab === 2 ? "navlink-full" : ""}`} onClick={() => setActiveTab(2)}><PhotoIcon className={"w-5 h-5"} />Image Post</button>                
                <button className={`navlink !w-full !px-2.5 !gap-2 !border-1 ${activeTab === 3 ? "navlink-full" : ""}`} onClick={() => setActiveTab(3)}><ViewColumnsIcon className={"w-5 h-5"} />Community</button>
            </div>    
