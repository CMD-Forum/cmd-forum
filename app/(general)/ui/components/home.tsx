...
export function Landing() {
    ...
    return (
        <div className='flex flex-col'>
            <div className="flex flex-col w-full from-[#1a1a19] to-zinc-950 bg-gradient-to-b items-center justify-center" style={{ height: wHeight - 60 - 230 }}>
                ...
                <Link href={"/login"} className="navlink mt-4">Already have an account?</Link>
            </div>
