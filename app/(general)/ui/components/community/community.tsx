...
export function CardCommunity( { community } : { community: Community } ) {
    ...
    return (
        <div className="flex flex-row w-full items-center gap-4 relative group transition-all bg-card border-0 border-border group-hover/title:!border-white h-fit rounded-md px-6 py-6">
            ...
            :
                <img src={"/text_post_icon.png"} alt={"This community has no image."} className="rounded-md hidden sm:flex sm:!max-w-[50px] sm:!min-w-[50x] m-auto sm:!h-[50px] sm:!w-[50px] overflow-hidden bg-cover" />
            }
