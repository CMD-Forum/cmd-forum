...
export function NavSideItems() {
    ...
    return (
        ...
        <AnimatePresence>
            ...
            <div className='flex-col gap-2 facebookTheme:gap-0 facebookTheme:sm:pl-6 px-3 py-3 facebookTheme:px-0 max-w-[400px] bg-zinc-950 facebookTheme:bg-white border-zinc-950 border-l-[1px] facebookTheme:border-[#b3b3b3] facebookTheme:border-l-0 facebookTheme:border-r-[1px] hidden sm:flex lg:!w-[400px]'>
