        ...
        <main className="flex min-h-screen flex-col w-full">
            ...
            <div className="error flex flex-col gap-4 w-full">
                ...
                <div className="flex flex-row gap-2">
                    <Link href="/support/understand-posting" className="flex flex-row bg-zinc-950 hover:bg-zinc-800 p-5 border-zinc-900 border-[1px] rounded-md gap-1 hover:gap-2 transition-all w-full h-full font-sans font-semibold text-lg items-center"> <ArrowLongLeftIcon className="inline-block transition-transform group-hover:translate-x-1 motion-reduce:transform-none h-6 w-6"></ArrowLongLeftIcon>Last Article</Link>    
